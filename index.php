...
<body>
    ...
    <div class="text-right mt-4 mx-4"><a class="btn btn-outline-info fs-3" href="./admin/login.php">LOGIN </a></div>
            ...
            <div class="content first-content">
              <div class="container-fluid">
                  ...
                  <div class="col-md-9">
                      ...
                      <div class="fb-btn"><a rel="nofollow" href="https://www.linkedin.com/in/taha-moataz">LinkedIn Page</a></div>
                  </div>
              </div>
            </div>
          </div>
            ...
            <div class="content fifth-content">
                <div class="container-fluid">
                    ...
                    if(isset($_POST['send'])){
                        ...
                        $insert="INSERT into `message`values(null,'$name','$email','$subject','$message');";
                    ...
                    <div class="col-md-6">
                        <form id="contact" action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                  <fieldset>
                                    <button name="send" id="form-submit" class="btn">Send Now</button>
                                  </fieldset>
                                </div>
                            </div>
                        </form>
        ...
        <div class="footer">
          <div class="content">
              <p>Copyright &copy; 2020 Company Name . Template: <a rel="nofollow" href="https://www.linkedin.com/in/taha-moataz">MOATAZ</a></p>
          </div>
        </div>
